...
for case_of_fxi = 1:3 %loop that runs 3 times, each time for one of the three functions
    ...
    l_C1 = 0.01 * ones(1,M);
    e_c1 = linspace(0.00004,0.004,M);
    [k_c1,a_c1,b_c1,calcs_c1] = bisector_method(case_of_fxi,l_C1,e_c1,a1,b1,M);
    %second case: l changeable and e = 0.001 (const)
    l_c2 = linspace(0.005,0.05,M); 
    e_c2 = 0.001 * ones(1,M);
    [k_c2,a_c2,b_c2,calcs_c2] = bisector_method(case_of_fxi,l_c2,e_c2,a1,b1,M);
    %third case: l = 0.01, e = 0.001
    l_c3 = 0.01;
    e_c3 = 0.001;
    [k_c3,a_c3,b_c3,calcs_c3] = bisector_method(case_of_fxi,l_c3,e_c3,a1,b1,1);
